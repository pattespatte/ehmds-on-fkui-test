    ...
    <main class="main">
      ...
      <section id="token-override" class="demo-section pattern-section">
        ...
        <div class="demo-block">
          ...
          <h3>EhmBadge</h3>
          <p class="fkui-reference__note">
            Same statuses and props as FBadge above — EhmBadge adds no API of
            its own. The only difference is the scoped CSS token overrides,
            which shift FBadge to the EHMDS palette.
          </p>
          <div class="demo-row">
            <EhmBadge status="default">Default</EhmBadge>
            <EhmBadge status="info">Info</EhmBadge>
            <EhmBadge status="success">Success</EhmBadge>
            <EhmBadge status="warning">Warning</EhmBadge>
            <EhmBadge status="error">Error</EhmBadge>
          </div>
        </div>

        <div class="demo-block">
          <span class="example-label">[EXAMPLE COMPONENT]</span>
          <h3>EhmBadge (inverted)</h3>
          <div class="demo-row">
            <EhmBadge status="default" :inverted="true"
              >Default Inverted</EhmBadge
            >
            <EhmBadge status="info" :inverted="true">Info Inverted</EhmBadge>
        ...
        <div class="code-block">
          <pre>
&lt;!-- Token Override: same API as FBadge, different tokens --&gt;
&lt;EhmBadge status="default"&gt;New Feature&lt;/EhmBadge&gt;</pre
          >
        </div>
      </section>
      ...
      <section id="wrapper" class="demo-section pattern-section">
        <div class="pattern-header">
          ...
          <router-link to="/docs/architecture/wrapper" class="pattern-docs-link"
            >Read documentation →</router-link
          >
        </div>
        ...
        <div class="demo-block">
          ...
          <div class="card-grid">
            ...
            <EhmCard variant="default" :has-error="showError">
              ...
              <template #footer>
                <button class="toggle-button" @click="showError = !showError">
                  Toggle
                </button>
              </template>
            </EhmCard>
...
&lt;/EhmCard&gt;</pre
      ...
      <section id="extension" class="demo-section pattern-section">
        <div class="pattern-header">
          ...
          <p class="pattern-description">
            Extends FKUI's <code>FTextField</code> with additional features
            while preserving all original functionality. Adds character count,
            helper text, error states, and prefix/suffix slots.
          </p>
          <router-link
...
/&gt;</pre
      ...
      <section id="composition" class="demo-section pattern-section">
        <div class="pattern-header">
          ...
          <p class="pattern-description">
            Composes <code>FTextField</code> with custom buttons and expandable
            toggle into a higher-level, domain-specific search component with
            coordinated state and behavior.
          </p>
          <router-link
        ...
        <div class="demo-block fkui-reference">
          ...
          <div class="fkui-search-reference">
            <FTextField
              ...
              :inline="true"
            />
            <button type="button" class="fkui-reference__btn">Search</button>
          </div>
        </div>
            ...
            >
              <template #results="{ query, isLoading }">
                <div class="search-results">
                  ...
                  <div
                    v-else-if="query && searchResults.length === 0"
                    class="search-empty"
                  >
            ...
            >
              <template #filters>
                <div class="search-filters">
                  <div class="filter-group">
                    <label
                      ><input type="checkbox" v-model="filters.inStock" /> In
                      Stock Only</label
                    >
                    <label
                      ><input type="checkbox" v-model="filters.onSale" /> On
                      Sale</label
                    >
                  </div>
                  <div class="filter-group">
              ...
              <template #results="{ query, isLoading }">
                <div class="search-results">
                  ...
                  <div
                    v-else-if="query && productResults.length === 0"
                    class="search-empty"
                  >
...
&lt;/EhmSearchBox&gt;</pre
    ...
    <footer class="footer">
      ...
      <p>
        ...
        <a href="https://designsystem.forsakringskassan.se/" target="_blank"
          >FKUI</a
        >
        <span aria-hidden="true">•</span>
